...
export const TRANSLATIONS: Record<SupportedLang, any> = {
  es: {
    ...
    placeCard: {
      ...
      realTime: "REAL TIME",
      verRuta: "VER RUTA TÁCTICA",
      leavesFrom: "SALE DE",
      duration: "DURACIÓN",
      roadStatus: "ESTADO VÍA",
      pavement: "PAVIMENTO",
      verTerminales: "VER TERMINALES",
      estimatedBudget: "PRESUPUESTO ESTIMADO",
      financialServices: "SEGURIDAD FINANCIERA",
      btnExchange: "CAMBIO DE MONEDA / BANCOS",
      btnExchangeSub: "LUGARES SEGUROS PARA CAMBIAR O RETIRAR DINERO",
      pasaje: "PASAJE",
      almuerzo: "ALMUERZO",
  ...
  en: {
    ...
    placeCard: {
      ...
      financialServices: "FINANCIAL SECURITY",
      btnExchange: "MONEY EXCHANGE / BANKS",
      btnExchangeSub: "SAFE PLACES TO EXCHANGE OR WITHDRAW CASH",
      pasaje: "TICKET",
      almuerzo: "LUNCH",
  ...
  pt: {
    ...
    offerCards: [
      ...
      { icon: Coffee, title: "Cultura Auténtica", desc: "Ensinamos você a falar como um local e a encontrar os lugares que outros não conhecem." },
    ...
    placeCard: {
      ...
      financialServices: "SEGURANÇA FINANCEIRA",
      btnExchange: "CÂMBIO / BANCOS",
      btnExchangeSub: "LUGARES SEGUROS PARA TROCAR OU RETIRAR DINHEIRO",
      pasaje: "PASSAGEM",
      almuerzo: "ALMOÇO",
      calcTotal: "CALCULAR TOTAL",
      calcPersons: "PESSOAS",
      ...
      quote: "Eavemaría mijo! Venha conhecer que isso aqui es um paraíso.",
      tips: {
        sazon: "SABOR LOCAL",
        cultura: "CULTURA",
        ruta: "VIA / ROTA",
